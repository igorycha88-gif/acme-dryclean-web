...
export const metadata: Metadata = {
  ...
  description:
    "Профессиональная выездная химчистка мягкой мебели, ковров, матрасов, ростовых кукол и салона авто в Москве и МО. Без предоплаты. Гарантия результата. Ежедневно 09:00–21:00.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "Профессиональная выездная химчистка мягкой мебели, ковров, матрасов, ростовых кукол и салона авто. Без предоплаты. Гарантия результата.",
  },
  twitter: {
    card: "summary_large_image",
    title: "Химчистка мебели на дому в Москве — D&A Dry Cleaning",
    description:
      "Профессиональная выездная химчистка мягкой мебели, ковров, матрасов, ростовых кукол и салона авто. Без предоплаты.",
  },
  robots: {
    index: true,
    follow: true,
