...
export const metadata: Metadata = {
  title:
    "Химчистка мебели на дому в Москве — выезд мастера за 1 час | da-dryclean",
  description:
    "Профессиональная выездная химчистка мягкой мебели, диванов, матрасов, ковров в Москве и МО. Выезд мастера в течение часа, безопасная химия, гарантия результата. Без предоплаты. Звоните: +7 (495) 226-15-73.",
  alternates: {
    canonical: SITE_URL,
  },
  keywords: [
