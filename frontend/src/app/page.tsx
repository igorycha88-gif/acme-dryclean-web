...
export const metadata: Metadata = {
  ...
  description:
    "Закажите выездную химчистку диванов, ковров, матрасов, штор и салона авто в Москве и МО. Без предоплаты. Гарантия результата. Более 5000 выполненных заказов. Ежедневно 09:00–21:00.",
  alternates: {
    canonical: SITE_URL,
  },
};
