...
const DIRECTIONS = [
  ...
  {
    title: "Матрасы",
    text: "Глубокая чистка и дезинфекция матрасов. Удаление пылевых клещей, пятен, аллергенов.",
  ...
  },
  {
    ...
    text: "Чистка и дезинфекция ростовых кукол и костюмов. Забор и доставка.",
